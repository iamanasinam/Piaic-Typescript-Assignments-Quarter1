...
const votingEligibility = (age: number, nationality: string) => {
  console.log("Task 2\n");
...
const findingDaysOfMonth = (month: number, year: number) => {
...
// fifth Task
const findingAge= (brithYear: number, yearNow: number)=>{
let age :number = yearNow - brithYear;
console.log(`Q1: Finding age based on the current year.\nI'm ${age} years old.`)}

// sixth Task
const areaOfTriangle = (_length :number, _width :number)=>{
...
// findNumberProperties(7)
// votingEligibility(9, "Pakistani");
// ageGroup(22);
// findingDaysOfMonth(6, 2009);
// findingAge(2000, 2024);
// areaOfTriangle(26, 28);
// areaOfCircle(3.14, 7)
// areaOfCube(7)
// temperatureConversion(66)
// sortingSeconds(2707)
// calculatingMarksPercentage(1100, 980)
